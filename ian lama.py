...
cl = LINETCR.LINE()
cl.login(token="ElhgZ4pDYGdq8JG69Q44.6OowBXq+Jy0nf7bEbCA0ba.9/LEyouj1MU3eY6Q74NizILIkCvD3kv90hy5n9SHXV4=")

ki = LINETCR.LINE()
ki.login(token="ElB6ISqNiCYPqrtIpPK0.PQVf82HpryeddPW9tbCmma.f0CVN5tdBf52y5RyiVFyruChJvZAT2SNLQooFi7or20=")

kk = LINETCR.LINE()
kk.login(token="ElD6yIqfHgwYFcus3FM4.Z/KYWQ4jucOEPlEi6sn7ra.n4xOrCH8fadOd4FVzTRvwFgeuaZAD12pLF23G6884pQ=")

kc = LINETCR.LINE()
kc.login(token="ElQEIBxfCkx88jxye9u6.fZ6Oit60RnHeCLKcjobFzG.rDQhcW5VtT2znmgAOOg7eUuO8zQfGtKTDozW6gscLCw=")
...
helpMessage =""" IaN BOT Menu   􀔃􀄆red check mark􏿿
