...
✞My Creator Http://line.me/ti/p/~lianekof
"""
KAC=[cl,ki,kk,kc,kl,kj,kh,ka,kz,ks,kb,kw]
...
def bot(op):
    try:
        ...
        if op.type == 11:
            if op.param2 not in Bots:
                return
            cl.sendText(op.param1,"Jangan Main Qr Goblog" + cl.getContact(op.param2).displayName)
            print "Update group"                   
        ...
        if op.type == 17:
           if wait["welcome"] == True: 
            ...
            cl.sendText(op.param1, "Welcome To " + str(ginfo.name))
			...
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
               ...
               if msg.from_ in admin: 
                ...
                if wait["autolike"] == True: md+=" Auto Like : on\n"
