...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,"ubce1a713f0cd01fa3b402ebd3e72ecb1"]
admin=["ubce1a713f0cd01fa3b402ebd3e72ecb1","uea83966f143f8d8d0d17b05e05c6b404",]
wait = {
    'contact':True,
    'autoJoin':True,
    'autoCancel':{"on":True,"members":200},
    'leaveRoom':True,
    'timeline':True,
    'autoAdd':False,
        ...
        if op.type == 19:            
                if mid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                            random.choice(KAC).inviteIntoGroup(op.param1,[op.param3],admin,Bots)
                        except:
              ...
              if msg.from_ in admin:
                if wait["protection"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Protectjoin on","Join on"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Protectjoin off","Join off"]:
              if msg.from_ in admin:
                    ...
                    if targets == []:                        
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendText(msg.to, "Succes Copy Contact" )
                            except:                                
                                pass                                                         
