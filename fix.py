...
cl = LINETCR.LINE()
cl.login(token="EltqQlWZCtXcl0x9Mkk4.6OowBXq+Jy0nf7bEbCA0ba.190oTjN9CarVKARxtr26r4n3c+tpW1yJUXq1DzzQyxw=")
        ...
        if op.type == 19:
          if wait["protection"] == True:  
           if op.param2 not in Bots:
              ...
              cl.inviteIntoGroup(op.param1,[op.param2],admin,Bots) 
              random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
              random.choice(KAC).inviteIntoGroup(op.param1,[op.param2],admin,Bots)              
           else:
               pass
