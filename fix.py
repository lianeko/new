...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            elif msg.text in ["Natsu ourl","Natsu link on"]:
               if msg.from_ in admin: 
                if msg.toType == 2:
               ...
               if msg.from_ in admin: 
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Natsu curl","Natsu link off"]:
               if msg.from_ in admin: 
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
               ...
               if msg.from_ in admin: 
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        kc.sendText(msg.to,"Not found Natsu")
                        ...
                        for target in targets:
                            try:
                                ...
                                kc.sendText(msg.to,"Succes Natsu")
