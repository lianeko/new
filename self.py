...
ak = LINETCR.LINE()
ak.login(token="EltqQlWZCtXcl0x9Mkk4.6OowBXq+Jy0nf7bEbCA0ba.190oTjN9CarVKARxtr26r4n3c+tpW1yJUXq1DzzQyxw=")
	...
	#-------------Fungsi Cek Tag Done---------------------#                    
         ...
         #-------------Fungsi Spam Pc Done---------------------#
             ...
             #----------------------------------------Fungsi Invite White Contact-------------------------------------------------#                         
            	...
            	if msg.from_ in admin:
                 wait["winvite"] = True
                 random.choice(KIL).sendText(msg.to,"send contact 😉")                        
             ...
             if msg.from_ in admin:   
              if msg.toType == 2:
                 ...
                 try:
                    ...
                    pass                                 
            elif msg.text in ["Clone"]:              
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uea83966f143f8d8d0d17b05e05c6b404'}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"My Clone")
                random.choice(KIL).sendText(msg.to,"My Clone")
