...
helpMessage =""" ✞I҉a҉N ҉B҉O҉T҉ ME҉N҉U҉   􀔃􀄆red check mark􏿿✞
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["All Join","All join","Ayo masuk","Join all"]:
              if msg.from_ in admin:
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Utama Start---------------------#
        ...
        #-------------Fungsi Speedbot Kedua Start---------------------# 
            elif msg.text in ["LA Sp","LA Speed","LA speed","Sp la"]:
               if msg.from_ in admin: 
                start = time.time()
        ...
        #-------------Fungsi Speedbot Ketiga Start---------------------#
            elif msg.text in ["WP Sp","WP Speed","WP speed","Sp wp"]:
               if msg.from_ in admin: 
                start = time.time()
         ...
         #-------------Fungsi Speedbot Keempat Start---------------------#
            elif msg.text in ["XxX Sp","XxX Speed","XxX speed","Sp xxx"]:
               if msg.from_ in admin: 
                start = time.time()
