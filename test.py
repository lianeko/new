...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
               ...
               if msg.from_ in admin: 
                ...
                kj.sendText(msg.to,"Yatogami Hadir")
                kh.sendText(msg.to,"Yatogami Hadir")
                ka.sendText(msg.to,"Yatogami Hadir")
                kz.sendText(msg.to,"Yatogami Hadir")
                ks.sendText(msg.to,"Yatogami Hadir")
                kb.sendText(msg.to,"Yatogami Hadir")
                kw.sendText(msg.to,"Yatogami Hadir")
